...
import profile from "../../Asset/form-illustrator/profile.svg";
        ...
        <nav className="bg-gray-800">
                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="hidden sm:block sm:ml-6">
                            ...
                            <div className="flex space-x-4">
                                <Link to='/'>
                                    <h1 className="text-white text-2xl font-semibold" >JS Encoder</h1>
                                </Link>
                                <Link to="/" className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Home</Link>

                                <Link to="/addApi" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Add Task</Link>
                            </div>
                        </div>
                    </div>
            ...
            <div className="sm:hidden" id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <Link to="addApi" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Add Data</Link>
                </div>
            </div>
        </nav>
